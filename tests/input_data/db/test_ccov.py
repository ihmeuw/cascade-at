...
@pytest.mark.skip
def test_country_covariates_real(mock_execution_context, demographics_default):

    ccov = country_covariates(mock_execution_context, demographics_default)
...
def test_country_covariates_mock(
        ...
        mock_ccov_estimates, expected_ccov, demographics_default):

    mock_get_covariate_estimates.return_value = mock_ccov_estimates

    pd.testing.assert_frame_equal(
        country_covariates(mock_execution_context, demographics_default),
