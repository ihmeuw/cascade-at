...
# -*- coding: utf-8 -*-
#
# Dismod AT documentation build utilities file, created by
# sphinx-quickstart on Mon Feb 12 19:52:18 2018.
#
# This file is execfile()d with the current directory set to its
# containing dir.
#
# Note that not all possible utilities values are present in this
# autogenerated file.
#
# All utilities values have a default; values that are commented out
...
try:
    release = get_distribution('cascade_at').version
...
man_pages = [(master_doc, "cascade_at", "Cascade Documentation", [author], 1)]
