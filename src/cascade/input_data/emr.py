...
from cascade.input_data.db.mortality import get_cause_specific_mortality_data, normalize_mortality_data
...
def add_emr_from_prevalence(model_context, execution_context):
    ...
    csmr = normalize_mortality_data(get_cause_specific_mortality_data(execution_context))
