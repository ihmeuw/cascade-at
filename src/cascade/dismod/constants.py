...
COMMAND_IO = dict(
    init=DismodIO(
        ["age", "avgint", "covariate", "data", "density", "integrand",
         ...
         "weight_grid", "weight"],
        ["age_avg", "var", "data_subset", "start_var", "scale_var"]),
    depend=DismodIO([], ["depend_var", "age_avg"]),
    set=DismodIO(
        ["sample", "prior_mean", "fit_var", "start_var", "scale_var", "truth_var"],
        ["start_var", "scale_var", "truth_var"]),
    fit=DismodIO(["data_sim"], ["fit_var", "fit_data_subset", "age_avg"]),
