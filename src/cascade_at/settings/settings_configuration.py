...
class Smoothing(Form):
    ...
    def _full_form_validation(self, root):
        ...
        if self._container._name == "rate":
            ...
            # TODO This repeats validation logic in cascade_at.model.rates but I don't see a good way to bring that in here
            is_negative = True
            is_positive = True
...
class Model(Form):
    ...
    drill = OptionField(["cascade_at", "drill"], display="Drill")
